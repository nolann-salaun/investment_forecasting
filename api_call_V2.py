...
'''This function retrieves the historical data for the ETFs inputed by the user
    ...
    - etf_allocation 
'''
def portfolio_data_retrieval(etf_list, investment_start_date, end_date):
...
def main_api_call():
    ...
    etfs, investment_start_date, end_date = user_input(investment_start_date,investment_durations) #Retrieve inputs from user
    data_dict = portfolio_data_retrieval(etfs, investment_start_date, end_date) #agregate user inputs with yfinance datas
